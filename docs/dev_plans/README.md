...
| Date | Type | Name | Status | Assignee | Branch | Plan |
|---|---|---|---|---|---|---|
| 2026-07-27 | chore | Release 0.4.0 — rename the CLI bridge to `pipecat context-hub` (alias `ch`) | In progress | markbackman | `rename/context-hub-command` | _(no plan file)_ |
