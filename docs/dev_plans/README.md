...
| Date | Type | Name | Status | Assignee | Branch | Plan |
|---|---|---|---|---|---|---|
| 2026-08-03 | feature | CLI/MCP self-report guidance parity (shared issue-template URLs, CLI bug-report hints, reranker `not_cached` warning) | Complete | vr000m | `feature/self-report-guidance-parity` | `20260803-feature-cli-mcp-report-hint-parity.md` |
