...
|---|---|---|---|---|---|---|
| 2026-06-12 | feat | Staleness footer on tool responses (both front doors) | In Review (PR #77) | vr000m | `feat/staleness-footer` | _(no plan file)_ |

## Completed Tasks
| Date | Type | Name | Status | Assignee | Branch | Plan |
|---|---|---|---|---|---|---|
| 2026-06-12 | feat | One-shot CLI query subcommands (every MCP tool as a shell command) | Complete (Unreleased) | vr000m | `feat/cli-query-subcommands` | `20260612-feature-cli-query-subcommands.md` |
