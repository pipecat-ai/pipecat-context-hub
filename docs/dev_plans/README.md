...
|---|---|---|---|---|---|---|
| 2026-05-29 | chore | chromadb 1.x migration + Python 3.14 prep (format break) | Not Started | vr000m | `chore/chromadb-1x-python-314` | `20260529-chore-chromadb-1x-python-314.md` |

## Completed Tasks
| Date | Type | Name | Status | Assignee | Branch | Plan |
|---|---|---|---|---|---|---|
| 2026-05-30 | fix | Bound `serve` lifetime to real client under `uv run` (grandparent-death watchdog) | Complete (unreleased) | vr000m | `fix/serve-uv-run-grandparent-watchdog` | `20260530-fix-serve-uv-run-grandparent-watchdog.md` |
